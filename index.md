...
1. **FAT32 (File Allocation Table 32)**
   Це справжній ветеран серед файлових систем, розроблений Microsoft ще у 90-х роках.

    - Головна перевага: Універсальність. Її "розуміють" майже всі пристрої: Windows, macOS, Linux, ігрові консолі, телевізори та автомагнітоли.

    - Головний мінус: Має жорстке обмеження — максимальний розмір одного файлу не може перевищувати 4 ГБ. Також вона не має вбудованих засобів безпеки (прав доступу) та стійкості до збоїв живлення.

    - Де використовується: USB-флешки, карти пам'яті, старе обладнання.

2. **NTFS (New Technology File System)**
    Сучасна стандартна файлова система для ОС Windows.

    - Особливості: Вона набагато надійніша за FAT32 завдяки журналюванню (записує зміни перед тим, як їх внести, що рятує дані при раптовому вимкненні світла). Підтримує величезні об’єми дисків та файлів (теоретично до 16 ЕБ).

    - Функціонал: Дозволяє встановлювати права доступу для різних користувачів, підтримує шифрування (EFS) та стиснення даних.

    - Де використовується: Системні диски Windows, зовнішні жорсткі диски великого об'єму.

3. **ext4 (Fourth Extended Filesystem)**
    Це стандарт де-факто для більшості дистрибутивів Linux (Ubuntu, Fedora тощо) та ОС Android.

    - Особливості: Дуже швидка та стійка до фрагментації. Як і NTFS, вона є журнальованою системою, що робить її безпечною у разі збоїв.

    - Гнучкість: Підтримує файли розміром до 16 ТБ і томи до 1 ЕБ. Вона ідеально підходить для серверів та систем з високим навантаженням.

    - Де використовується: Комп'ютери на Linux, смартфони Android, сервери.
